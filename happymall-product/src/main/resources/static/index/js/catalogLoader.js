            ...
            if(ctgnums){
                ...
                $.each(ctgnumArray,function (i,ctg1Id) {
                    ...
                    $.each(ctg2list,function (i,ctg2) {
                        var cata2link=$("<a href='#' style= 'color: #111; font-size: x-small; font-family: sans-serif' class='aaa'>"+ctg2.name+"  ></a>");
                        ...
                        $.each(ctg3List,function (i,ctg3) {
                            var cata3link = $("<a href=\"http://search.happymall.com/list.html?catalog3Id="+ctg3.id+"\" style=\"color: #999;\">" + ctg3.name + "</a>");
                            li.append(cata3link);
