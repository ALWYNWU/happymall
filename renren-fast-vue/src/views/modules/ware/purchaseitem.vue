  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item label="Warehouse">
        <el-select style="width:120px;" v-model="dataForm.wareId" placeholder="Select Warehouse" clearable>
    ...
    >
      ...
      <el-table-column prop="skuId" header-align="center" align="center" label="采购productid"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        `确定对[id=${ids.join(",")}]进行[${id ? "Delete" : "Delete"}]Operation?`,
        "",
        {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
