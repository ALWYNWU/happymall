<template>
  ...
  >
    <el-form
      ...
      label-width="120px"
    >
      <el-form-item label="采购productid" prop="skuId">
        <el-input v-model="dataForm.skuId" placeholder="采购productid"></el-input>
      </el-form-item>
...
export default {
  data() {
    return {
      ...
      dataRule: {
        skuId: [
          { required: true, message: "采购productid不能为空", trigger: "blur" }
        ],
        skuNum: [
          { required: true, message: "采购数量不能为空", trigger: "blur" }
        ],
        wareId: [{ required: true, message: "Warehouse Id不能为空", trigger: "blur" }]
      }
    };
  },
  created(){
