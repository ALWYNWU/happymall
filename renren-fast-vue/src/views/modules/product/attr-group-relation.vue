<template>
  <div>
    <el-dialog :close-on-click-modal="false" :visible.sync="visible" @closed="dialogClose">
      <el-dialog width="40%" title="Choose Attribute" :visible.sync="innerVisible" append-to-body>
        <div>
          ...
          >
            ...
            <el-table-column prop="attrId" header-align="center" align="center" label="Attribute Id"></el-table-column>
            <el-table-column prop="attrName" header-align="center" align="center" label="Attribute Name"></el-table-column>
            <el-table-column prop="icon" header-align="center" align="center" label="Attribute Icon"></el-table-column>
            <el-table-column prop="valueSelect" header-align="center" align="center" label="Optional Value"></el-table-column>
          </el-table>
          <el-pagination
      ...
      <el-row>
        <el-col :span="24">
          <el-button type="primary" @click="addRelation">New Relationship</el-button>
          <el-button
            type="danger"
  ...
  methods: {
    ...
    batchDeleteRelation(val) {
      ...
      this.$http({
        ...
        if (data.code == 0) {
          this.$message({ type: "success", message: "Deletesuccessfully" });
    ...
    submitAddRealtion() {
      ...
      //准备数据
      console.log("准备Add的数据", this.innerdataListSelections);
      if (this.innerdataListSelections.length > 0) {
        ...
        this.$http({
          ...
          if (data.code == 0) {
            this.$message({ type: "success", message: "Add关联successfully" });
          }
