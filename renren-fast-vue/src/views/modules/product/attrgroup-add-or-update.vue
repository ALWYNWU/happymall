<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="所属Category" prop="catelogId">
        <!-- <el-input v-model="dataForm.catelogId" placeholder="Category Id"></el-input> @change="handleChange" -->
        <!-- <el-cascader filterable placeholder="Try search: phone" v-model="catelogPath" :options="categorys"  :props="props"></el-cascader> -->
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        icon: [{ required: true, message: "Group Icon不能为空", trigger: "blur" }],
        catelogId: [
          { required: true, message: "Category Id不能为空", trigger: "blur" }
        ]
      }
    };
  },
