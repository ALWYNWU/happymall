    ...
    >
      <el-table-column type="expand">
        <template slot-scope="scope">
          product标题：{{scope.row.skuTitle}}
          <br />
          product副标题：{{scope.row.skuSubtitle}}
          <br />
          productDescription：{{scope.row.skuDesc}}
          <br />
      ...
      <el-table-column prop="saleCount" header-align="center" align="center" label="sales volume"></el-table-column>
