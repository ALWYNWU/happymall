  ...
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column
        ...
        label="场次id"
      ></el-table-column>
      <el-table-column prop="skuId" header-align="center" align="center" label="productid"></el-table-column>
      <el-table-column prop="seckillPrice" header-align="center" align="center" label="秒杀Price"></el-table-column>
