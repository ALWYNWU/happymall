<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="会员对应Price" prop="memberPrice">
        <el-input v-model="dataForm.memberPrice" placeholder="会员对应Price"></el-input>
      </el-form-item>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        memberPrice: [
          { required: true, message: "会员对应Price不能为空", trigger: "blur" }
        ],
        addOther: [
          {
            required: true,
