<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="name" header-align="center" align="center" label="场次Name"></el-table-column>
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="Operation">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="relationProduct(scope.row.id)">关联product</el-button>
