<template>
  <el-dialog
    ...
    <el-form-item label="等级Name" prop="name">
      <el-input v-model="dataForm.name" placeholder="等级Name"></el-input>
    </el-form-item>
    ...
    <el-form-item label="是否有会员Price特权" prop="priviledgeMemberPrice">
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          name: [
            { required: true, message: '等级Name不能为空', trigger: 'blur' }
          ],
          growthPoint: [
          ...
          priviledgeMemberPrice: [
            { required: true, message: '是否有会员Price特权不能为空', trigger: 'blur' }
          ],
          priviledgeBirthday: [
