<template>
  <el-dialog
    ...
    <el-form-item label="Delete状态【0->未Delete；1->已Delete】" prop="deleteStatus">
      <el-input v-model="dataForm.deleteStatus" placeholder="Delete状态【0->未Delete；1->已Delete】"></el-input>
    </el-form-item>
    ...
    <el-form-item label="Edit时间" prop="modifyTime">
      <el-input v-model="dataForm.modifyTime" placeholder="Edit时间"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          deleteStatus: [
            { required: true, message: 'Delete状态【0->未Delete；1->已Delete】不能为空', trigger: 'blur' }
          ],
          useIntegration: [
          ...
          modifyTime: [
            { required: true, message: 'Edit时间不能为空', trigger: 'blur' }
          ]
        }
      }
    },
