<template>
  <el-dialog
    ...
    <el-form-item label="退货productid" prop="skuId">
      <el-input v-model="dataForm.skuId" placeholder="退货productid"></el-input>
    </el-form-item>
    ...
    <el-form-item label="product图片" prop="skuImg">
      <el-input v-model="dataForm.skuImg" placeholder="product图片"></el-input>
    </el-form-item>
    <el-form-item label="productName" prop="skuName">
      <el-input v-model="dataForm.skuName" placeholder="productName"></el-input>
    </el-form-item>
    <el-form-item label="productBrand" prop="skuBrand">
      <el-input v-model="dataForm.skuBrand" placeholder="productBrand"></el-input>
    </el-form-item>
    <el-form-item label="product销售属性(JSON)" prop="skuAttrsVals">
      <el-input v-model="dataForm.skuAttrsVals" placeholder="product销售属性(JSON)"></el-input>
    </el-form-item>
    <el-form-item label="退货数量" prop="skuCount">
      <el-input v-model="dataForm.skuCount" placeholder="退货数量"></el-input>
    </el-form-item>
    <el-form-item label="product单价" prop="skuPrice">
      <el-input v-model="dataForm.skuPrice" placeholder="product单价"></el-input>
    </el-form-item>
    <el-form-item label="product实际支付单价" prop="skuRealPrice">
      <el-input v-model="dataForm.skuRealPrice" placeholder="product实际支付单价"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          skuId: [
            { required: true, message: '退货productid不能为空', trigger: 'blur' }
          ],
          orderSn: [
          ...
          skuImg: [
            { required: true, message: 'product图片不能为空', trigger: 'blur' }
          ],
          skuName: [
            { required: true, message: 'productName不能为空', trigger: 'blur' }
          ],
          skuBrand: [
            { required: true, message: 'productBrand不能为空', trigger: 'blur' }
          ],
          skuAttrsVals: [
            { required: true, message: 'product销售属性(JSON)不能为空', trigger: 'blur' }
          ],
          skuCount: [
            { required: true, message: '退货数量不能为空', trigger: 'blur' }
          ],
          skuPrice: [
            { required: true, message: 'product单价不能为空', trigger: 'blur' }
          ],
          skuRealPrice: [
            { required: true, message: 'product实际支付单价不能为空', trigger: 'blur' }
          ],
          reason: [
