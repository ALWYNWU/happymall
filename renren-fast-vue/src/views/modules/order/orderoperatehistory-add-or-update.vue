<template>
  <el-dialog
    ...
    <el-form-item label="Operation人[用户；系统；后台管理员]" prop="operateMan">
      <el-input v-model="dataForm.operateMan" placeholder="Operation人[用户；系统；后台管理员]"></el-input>
    </el-form-item>
    <el-form-item label="Operation时间" prop="createTime">
      <el-input v-model="dataForm.createTime" placeholder="Operation时间"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          operateMan: [
            { required: true, message: 'Operation人[用户；系统；后台管理员]不能为空', trigger: 'blur' }
          ],
          createTime: [
            { required: true, message: 'Operation时间不能为空', trigger: 'blur' }
          ],
          orderStatus: [
