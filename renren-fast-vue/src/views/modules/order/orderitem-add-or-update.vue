<template>
  <el-dialog
    ...
    <el-form-item label="productCategoryid" prop="categoryId">
      <el-input v-model="dataForm.categoryId" placeholder="productCategoryid"></el-input>
    </el-form-item>
    <el-form-item label="productsku编号" prop="skuId">
      <el-input v-model="dataForm.skuId" placeholder="productsku编号"></el-input>
    </el-form-item>
    <el-form-item label="productsku名字" prop="skuName">
      <el-input v-model="dataForm.skuName" placeholder="productsku名字"></el-input>
    </el-form-item>
    <el-form-item label="productsku图片" prop="skuPic">
      <el-input v-model="dataForm.skuPic" placeholder="productsku图片"></el-input>
    </el-form-item>
    <el-form-item label="productskuPrice" prop="skuPrice">
      <el-input v-model="dataForm.skuPrice" placeholder="productskuPrice"></el-input>
    </el-form-item>
    <el-form-item label="product购买的数量" prop="skuQuantity">
      <el-input v-model="dataForm.skuQuantity" placeholder="product购买的数量"></el-input>
    </el-form-item>
    <el-form-item label="product销售属性组合（JSON）" prop="skuAttrsVals">
      <el-input v-model="dataForm.skuAttrsVals" placeholder="product销售属性组合（JSON）"></el-input>
    </el-form-item>
    <el-form-item label="product促销分解金额" prop="promotionAmount">
      <el-input v-model="dataForm.promotionAmount" placeholder="product促销分解金额"></el-input>
    </el-form-item>
    ...
    <el-form-item label="该product经过优惠后的分解金额" prop="realAmount">
      <el-input v-model="dataForm.realAmount" placeholder="该product经过优惠后的分解金额"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          spuBrand: [
            { required: true, message: 'Brand不能为空', trigger: 'blur' }
          ],
          categoryId: [
            { required: true, message: 'productCategoryid不能为空', trigger: 'blur' }
          ],
          skuId: [
            { required: true, message: 'productsku编号不能为空', trigger: 'blur' }
          ],
          skuName: [
            { required: true, message: 'productsku名字不能为空', trigger: 'blur' }
          ],
          skuPic: [
            { required: true, message: 'productsku图片不能为空', trigger: 'blur' }
          ],
          skuPrice: [
            { required: true, message: 'productskuPrice不能为空', trigger: 'blur' }
          ],
          skuQuantity: [
            { required: true, message: 'product购买的数量不能为空', trigger: 'blur' }
          ],
          skuAttrsVals: [
            { required: true, message: 'product销售属性组合（JSON）不能为空', trigger: 'blur' }
          ],
          promotionAmount: [
            { required: true, message: 'product促销分解金额不能为空', trigger: 'blur' }
          ],
          couponAmount: [
          ...
          realAmount: [
            { required: true, message: '该product经过优惠后的分解金额不能为空', trigger: 'blur' }
          ],
          giftIntegration: [
