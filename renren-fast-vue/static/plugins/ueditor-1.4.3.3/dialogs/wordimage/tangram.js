...
/**
 * Operationflash对象的方法，包括创建flash对象、获取flash对象以及判断flash插件的版本号
 * @namespace baidu.swf
 */
baidu.swf = baidu.swf || {};
 ...
 * @param {String} 	options.errorMessage 		未安装flash player或flash player版本号过低时的
 ...
 * @param {string} name flash对象的Name
 * @see baidu.swf.create
 * @meta standard
