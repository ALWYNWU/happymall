...
(function( root, factory ) {
    ...
    define('widgets/widget',[
         ...
         * @param  {object} responseMap APIName与函数实现的映射
         * @example
         *     Uploader.register( {
    ...
    /**
     * @fileOverview 图片Operation, 负责预览图片和上传前压缩图片
     */
    ...
    define('queue',[
        ...
        function Queue() {
             ...
             * 统计文件数。
             * * `numOfQueue` 队列中的文件数。
             * * `numOfSuccess` 上传successfully的文件数
             * * `numOfCancel` 被移除的文件数
        ...
        $.extend( Queue.prototype, {
            ...
            /**
             * 对队列进行Sort，能够控制文件上传顺序。
             * @grammar sort( fn ) => undefined
             * @method sort
             * @param {Function} fn Sort方法
             */
            sort: function( fn ) {
    ...
    define('widgets/queue',[
        ...
        return Uploader.register({
             ...
             * @method sort
             * @grammar sort( fn ) => undefined
             * @description Sort队列中的文件，在上传之前调整可以控制上传顺序。
             * @for  Uploader
             */
            sortFiles: function() {
    ...
    define('widgets/upload',[
        ...
        Uploader.register({
             ...
             * @description 当文件上传successfully时触发。
             * @for  Uploader
             */
             ...
             * @param {File} [file] File对象
             * @description 不管successfully或者失败，文件上传完成时触发。
             * @for  Uploader
             */
            ...
            _doSend: function( block ) {
                ...
                requestAccept = function( reject ) {
                    ...
                    // 服务端响应了，不代表successfully了，询问是否响应正确。
     ...
     * @fileOverview Transport
     * @todo 支持chunked传输，优势：
     * 可以将大文件分成小块，挨个传输，可以提高大文件successfully率，当失败的时候，也只需要重传那小部分，
